...
vault kv put ssh-host-signer/roles/hostrole ttl=87600h \
...
vault kv put ssh-client-signer/roles/clientrole @/home/vagrant/clientrole.json


logger "Configuring Vault SSH OTP backend"
vault secrets enable ssh
vault kv put ssh/roles/otp_key_role \
  key_type=otp \
  default_user=vagrant \
